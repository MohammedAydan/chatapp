...
class GetChatMessagesFromLocalAsStreamUsecase {
  final ChatRepository _repository;
  
  const GetChatMessagesFromLocalAsStreamUsecase(this._repository);

  Future<Either<Failure, Stream<List<ChatMessageEntity>>>> call(
    GetChatMessageParams params,
  ) {
    return _repository.getChatMessageFromLocalAsStream(params);
  }
}
